...
/// @nodoc
mixin _$Post {
  int get commentCount => throw _privateConstructorUsedError; // コメントの数
  String get content => throw _privateConstructorUsedError; // 投稿の内容
  dynamic get createdAt => throw _privateConstructorUsedError; // 投稿の作成日時
  int get likeCount => throw _privateConstructorUsedError; // いいねの数
